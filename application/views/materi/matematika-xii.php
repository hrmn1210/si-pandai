...
Si-Pandai adalah Web edukasi yang dilengkapi video, materi dan sistem ujian
yang tersedia secara gratis. Si-Pandai dibuat ditujukan agar para siswa dan
...
<head>
    ...
    <title>Matematika | Kelas XII - Si-Pandai</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('welcome') ?>"><img src="<?= base_url('assets/') ?>img/logo1.png" alt=""></a>
        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    <h1 class="display-4" data-aos="fade-down" data-aos-duration="1400">Silahkan pilih materi yang
                        akan
                        kamu pelajari !
                    </h1>
