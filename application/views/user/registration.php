...
<head>
    ...
    <title>Si-Pandai - Belajar Dimana Saja & Kapan Saja!</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="mailto:Si-Pandai@gmail.com">Si-Pandai@gmail.com</a>
                </div>
            </div>
        </div>
        <div class="main_menu">
