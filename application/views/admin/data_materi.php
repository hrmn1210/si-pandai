...
<head>
    ...
    <title>Data Materi - Si-Pandai</title>
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Materi Si-Pandai</h2>
                            <hr>
                            <p class="card-text"> Tekan tombol dibawah ini untuk menambahkan materi.</p>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2024 <div class="bullet"></div> <a href="https://github.com/syauqi">Si-Pandai Team</a>
        </div>
    </footer>
    <!-- End Footer -->
