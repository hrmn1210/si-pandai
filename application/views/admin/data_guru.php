...
<head>
    ...
    <title>Data Guru - Si-Pandai</title>
    <!-- General CSS Files -->
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Guru Si-Pandai</h2>
                            <hr>
                            <p class="card-text"> Tekan tombol dibawah ini untuk menambahkan akun baru nntuk guru </p>
                        ...
                        <div class="col-md-12">
                            <div class="bg-white p-4"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <p class="small font-weight-bold">Pendaftaran guru hanya dapat dilakukan admin dan
                                        tidak bisa dilakukan sendiri</p>
                                </div>
                            </div>
                        </div>
                    </div>
