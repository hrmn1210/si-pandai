...
<head>
    ...
    <title>Data Siswa - Si-Pandai</title>
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Siswa Si-Pandai</h2>
                            <hr>
                            <p class="card-text"> Tekan tombol dibawah ini jika ingin menambahkan data siswa baru</p>
