...
<head>
    ...
    <title>Admin Dashboard - Si-Pandai</title>
    <!-- General CSS Files -->
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - Si-Pandai</div>
                            ...
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- <?php 
        // Ambil data siswa pertama berdasarkan kriteria
        $query = $this->db->get_where('siswa', ['id' => 40], 1); // Ambil siswa dengan ID = 1
        $siswa = $query->row(); // Ambil hasil query sebagai objek
        echo $siswa ? $siswa->nama : 'Tidak ada data siswa'; // Tampilkan nama siswa atau pesan kosong
        ?> -->
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Ini Adalah menu untuk menambahkan materi, silahkan pilih nama
                                    gurunya lalu masukkan video yang ingin di upload</p>
                                <a href="<?= base_url('admin/tambah_materi') ?>" class="btn btn-success">Tambah Materi
                                    ⭢</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="hero text-white hero-bg-image"
                            ...
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">Tekan tombol dibawah ini untuk melihat data siswa yang sudah terdaftar
                                    di SI-PANDAI</p>
                                <div class="mt-4">
            ...
            <footer class="main-footer">
                <div class="text-center">
                    Copyright &copy; 2024 <div class="bullet"></div><a href="#">Si-Pandai Team</a>
                </div>
            </footer>
            <!-- End Footer -->
