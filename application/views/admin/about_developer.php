                ...
                <section class="section">
                    <div class="">
                        <div class="hero text-white hero-bg-image"
                            ...
                            <div class="col-md-4 mx-auto rounded-circle bg-white p-3"
                                ...
                                <img src="<?= base_url('assets/img/') ?>modal-login.png"
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Si-Pandai team</h2>
                                <hr>
                                <p class="card-text">SI-PANDAI Team adalah salah satu kelompok mahasiswa UBSI yang saat
                                    ini berada di semester 5. <br> Team ini akan terus mengembangkan SI-PANDAI hingga
                                    bisa diminati sekolah-sekolah khususnya yang ada di kota Pontianak</p>
                            </div>
                        </div>
                    </div>
                    <br>
