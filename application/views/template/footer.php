    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li>SI-PANDAI Team adalah team yang merancang SI-PANDAI Juga merupakan mahasiswa UBSI semester 5
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Si-Pandai</h4>
                <p>
                    Web Edukasi Open Source yang dibuat oleh Si-Pandai Team. Si-Pandai adalah Web edukasi yang
                    dilengkapi video, materi. Si-Pandai dibuat ditujukan agar para siswa dan guru dapat terus belajar
                    dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> Si-Pandai is made with <span
                    class="text-danger"> &#10084;</span> by <a href="#">Si-Pandai Team</a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
                        ...
                        <div class=" col-md-6">
                            <form action="<?= base_url('welcome/validateLogin') ?>" method="post">
                                ...
                                <a class="btn btn-block font-weight-bold"
                                    ...
                                    href="<?= base_url('welcome/guru') ?>">Login
                                    Sebagai Guru!</a>
                            </form>
                        </div>
                    </div>
