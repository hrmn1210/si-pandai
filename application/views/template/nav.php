        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="mailto:apps.Si-Pandai@gmail.com">Si-Pandai@gmail.com</a>
                </div>
            </div>
        </div>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('welcome/admin') ?>"><img src="<?= base_url('assets/') ?>img/logo1.png" alt=""></a>
