...
<head>
    <meta charset="utf-8" />
    <title>Si-Pandai - Tambah Materi</title>
...
echo $data['user']['nama_mapel'];?>" class="form-control" id="inputEmail4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <?php
                                                            ...
                                                            $qry = mysqli_query($koneksi, "SELECT MAX(id) as max_id FROM materi");

                                                            // Periksa apakah query berhasil dan ada hasilnya
                                                            if ($t = mysqli_fetch_array($qry)) {
                                                                $next_id = $t['max_id'] + 1;  // Hitung ID yang baru akan dibuat
                                                                echo "ID berikutnya yang akan dibuat: " . $next_id;  // Tampilkan ID berikutnya
                                                            }
                                                            ?>
                                        </div>
                                    </div>
                ...
                <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                    <div class="kt-footer__copyright">
                        2024&nbsp;&copy;&nbsp;<a href="https://syauqizaidan.github.io/" target="_blank"
                            class="kt-link">Si-Pandai Team</a>
                    </div>
                    <div class="kt-footer__menu">
                        Made with &nbsp; <span class="" style="color: red"> &#10084;</span> &nbsp; by Si-Pandai Team
                    </div>
                </div>
