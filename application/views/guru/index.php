...
<>
    <meta charset="utf-8" />
    <title>Si-Pandai - Teacher Page</title>
        ...
        <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
            <div class="kt-header-mobile__logo">
                <a href="<?=base_url('guru/add_materi')?>">
                    <img alt="Logo" src="<?=base_url('assets')?>/img/logo1.png" width="90px;" />
                </a>
            </div>
                    ...
                    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                        <div class="kt-aside__brand-logo">
                            <a href="<?=base_url('guru')?>">
                                <img alt="Logo" width="35px;" src="<?=base_url('assets')?>/img/icon.png" />
                            </a>
                        </div>
                    </div>
...
?> !
                                                ...
                                                <div class="kt-widget19__labels">
                                                    <a href="#"
                                                        class="btn btn-label-light-o2 btn-bold btn-sm ">Si-Pandai</a>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="card card-statistic-1">
                                                            <div class="card-wrap">
                                                                <div class="card-header">
                                                                    <h4>Mapel Yang diajar</h4>
                                                                </div>
                                                                <div class="card-body font-weight-bold">
                                                                    <?php $this->db->get_where('guru', ['email'=>$this->session->userdata('email')])->row_array(); echo $data ['user'] ['nama_mapel'];?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                $guru = $this->db->get_where('guru', ['email' => $email_pengguna])->row_array();
                $nama_guru = $guru['nama_guru']; // Ambil nama guru dari data guru yang sedang login

                // Menghitung materi di mana nama_guru sesuai dengan nama pengguna yang login
                ...
                // Hitung jumlah kelas unik yang diajar oleh guru ini
                $this->db->select('kelas');
                $this->db->where('nama_guru', $nama_guru);
                $this->db->distinct(); // Menghitung kelas unik
                $this->db->from('materi');
                $jumlah_kelas = $this->db->count_all_results();
                ...
                ?>
                                                ...
                                                <div class="">
                                                    <div class="card" style="width:100%;">
                                                        <div class="card-body">
                                                            <h2 class="card-title" style="color: black;">Tambah Materi?
                                                            </h2>
                                                            <hr>
                                                            <p class="card-text">Dibawah ini adalah form untuk menambah
                                                                materi</p>
                                                            <a href="<?= base_url('guru/add_materi') ?>"
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Daftar Materi Yang Diunggah</h4>
                                    </div>
                                    <div class="card-body">
                    ...
                    // Ambil data materi berdasarkan nama guru
                    $materi = $this->db->get_where('materi', ['nama_guru' => $nama_guru])->result_array();
                    ...
                    foreach ($materi as $m) : ?>
                            ...
                            <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                                <div class="kt-footer__copyright">
                                    2024&nbsp;&copy;&nbsp;<a href="#" target="_blank" class="kt-link">Si-Pandai Team</a>
                                </div>
                                <div class="kt-footer__menu">
                                    Made with &nbsp; <span class="" style="color: red"> &#10084;</span> &nbsp; by
                                    Si-Pandai Team
                                </div>
                            </div>
                ...
                <script
                    ...
                    type="text/javascript"></script>
                <script
                    src="<?=base_url('assets')?>/assets/vendors/custom/components/vendors/bootstrap-datepicker/init.js"
                    type="text/javascript">
                </script>
                <script
                ...
                <script
                    src="<?=base_url('assets')?>/assets/vendors/custom/components/vendors/bootstrap-timepicker/init.js"
                    type="text/javascript">
                </script>
                <script
                    src="<?=base_url('assets')?>/assets/vendors/general/bootstrap-daterangepicker/daterangepicker.js"
                    type="text/javascript">
                </script>
                <script
                    ...
                    type="text/javascript"></script>
                <script
                    src="<?=base_url('assets')?>/assets/vendors/general/bootstrap-maxlength/src/bootstrap-maxlength.js"
                    type="text/javascript">
                </script>
                <script
                    ...
                    type="text/javascript"></script>
                <script
                    src="<?=base_url('assets')?>/assets/vendors/general/bootstrap-select/dist/js/bootstrap-select.js"
                    type="text/javascript">
                </script>
                <script
                    src="<?=base_url('assets')?>/assets/vendors/general/bootstrap-switch/dist/js/bootstrap-switch.js"
                    type="text/javascript">
                </script>
                ...
                <script src="<?=base_url('assets')?>/assets/vendors/general/bootstrap-markdown/js/bootstrap-markdown.js"
                    type="text/javascript"></script>
                <script
                    src="<?=base_url('assets')?>/assets/vendors/custom/components/vendors/bootstrap-markdown/init.js"
                    type="text/javascript">
                </script>
                ...
                <script src="<?=base_url('assets')?>/assets/vendors/general/jquery-validation/dist/jquery.validate.js"
                    type="text/javascript"></script>
                <script
                    src="<?=base_url('assets')?>/assets/vendors/general/jquery-validation/dist/additional-methods.js"
                    type="text/javascript">
                </script>
